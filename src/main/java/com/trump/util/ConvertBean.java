...
public class ConvertBean {
    ...
    /*mysql url的连接字符串*/
    private static String url = "jdbc:mysql://120.26.113.253:3306/recruitment?useUnicode=true&characterEncoding=utf8";
    //账号
    private static String user = "tianli";
    //密码
    ...
    //数据库中的表名
    private static String table = "rc_work";
    //数据库的列名称
    ...
    public static void main(String[] args) {
        System.err.println(new ConvertBean().getClassStr());
    }
